      ...
      <div className="p-8 space-y-6 bg-slate-50/50 min-h-[calc(100vh-64px)]">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl">
            ...
            {/* Change Password Card (Right Side) */}
            <div className="lg:col-span-2">
              <Card className="border border-slate-100 bg-white shadow-sm rounded-2xl overflow-hidden">
                <CardHeader className="px-6 py-5 bg-white">
                  <div className="flex items-center gap-2">
                    <Key className="size-4.5 text-[#e06f46]" />
                    <CardTitle className="text-sm font-bold text-slate-900">Thay Đổi Mật Khẩu</CardTitle>
                  </div>
                  <CardDescription className="text-xs text-slate-400 font-light mt-1">
                    Vui lòng nhập mật khẩu cũ cùng mật khẩu mới để tăng tính an toàn cho tài khoản nội bộ.
                  </CardDescription>
                </CardHeader>
                  ...
                  <form onSubmit={handlePasswordChange} className="space-y-4 max-w-md">
                    ...
                    <div className="pt-2">
                      <Button 
                        type="submit" 
                        disabled={saving}
                        className="bg-[#e06f46] hover:bg-[#d05e36] text-white rounded-lg h-10 px-5 font-semibold transition-all duration-200 active:scale-[0.98] shadow-sm flex items-center gap-2"
                      >
